...
#### While loop
You can make a block of code execute ovre and over again using a while statement. The code in a *while* clause will be executed as long as the while statement's condition is *True*
